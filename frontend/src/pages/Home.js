...
export const Home = () => {
  ...
  return (
    ...
    <div className={styles.cardSection}>
        ...
        <CustomCard title="Student" content="Our online platform is dedicated to empowering students and job seekers with the skills, resources, and opportunities they need." link="/str" button="Sign Up"/>
    </div>
    </div>
  )
}
